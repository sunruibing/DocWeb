 ...
 */
@WebServlet(name = "FindDoctorCommentByDoctorId", urlPatterns = {
		"/FindDoctorCommentByDoctorId"})
public class FindDoctorCommentByDoctorId extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			List<Map<String, Object>> doctorCommentList = new DoctorService()
					.queryThisDoctorAllCommentByDoctorId(doctorId);
