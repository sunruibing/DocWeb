 ...
 *         2016年10月14日
 */
@WebServlet(name = "DeleteCollectByUserIdAndCyclopediaId", urlPatterns = {
		"/DeleteCollectByUserIdAndCyclopediaId"})
public class DeleteCollectByUserIdAndCyclopediaId extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		int msg = new CollectService()
				.deleteCollectByUserIdAndCyclopediaId(userId, cyclopediaId);
		if (1 == msg) {
