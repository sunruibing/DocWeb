 ...
 */
@WebServlet(name = "FindCollectExistByUserIdAndCyclopediaId", urlPatterns = {
...
public class FindCollectExistByUserIdAndCyclopediaId extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {
		try {
			int msg = new CollectService().queryCollectByUserIdAndCyclopediaId(
					Integer.parseInt(request.getParameter("userId")),
					Integer.parseInt(request.getParameter("cyclopediaId")));
			if (msg == 0) {
