 ...
 */
@WebServlet(name = "FindOrderListByUserId", urlPatterns = {
		"/FindOrderListByUserId"})
public class FindOrderListByUserId extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			List<Map<String, Object>> registrationList = new RegistrationService()
					.queryRegistrationListByUserId(
