 ...
 */
@WebServlet(name = "FindCyclopediaRandomTwo", urlPatterns = {
		"/FindCyclopediaRandomTwo"})
public class FindCyclopediaRandomTwo extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			List<Cyclopedia> cyclopediaList = new CyclopediaService()
					.queryCyclopediaRandomTwo();
