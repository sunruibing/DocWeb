...
public class UpdateDisease extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		String doctor_answer_question = request
				.getParameter("doctorAnswerQuestion");
		...
		try {
			diseaseService.updataDisease(id, name, bio, user_icon, user_name,
					user_put_question, doctor_icon, doctor_name,
					doctor_answer_question, symptom, cure, prompt, section_id,
					doctor_id);
