...
/**
 * @author FFFF Put undefined The's Not me want. insert in angel nice 2016年9月30日
 */
@WebServlet(name = "FindUserIntradayByUserIdAndDate", urlPatterns = {
		"/FindUserIntradayByUserIdAndDate"})
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			Registration registration = new RegistrationService()
					.queryUserIntradayByUserIdAndDate(userId, date);
