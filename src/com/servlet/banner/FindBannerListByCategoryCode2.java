 ...
 *         2016年10月29日
 */
@WebServlet(name = "FindBannerListByCategoryCode2", urlPatterns = {
		"/FindBannerListByCategoryCode2"})
public class FindBannerListByCategoryCode2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			List<Map<String, Object>> banner = new BannerService()
					.queryBannerListByCategory2();
