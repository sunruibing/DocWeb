...
public class FindCalendarList extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			List<Map<String, Object>> calendarList = new CalendarService()
					.queryCalendarListByDateAndUserId(date, userId);
			response.getWriter().print(new Gson().toJson(calendarList));// success
