...
public class DiseaseService {
    public List<String> queryDiseaseList(Integer sectionId) throws SQLException{
    	String sql = "SELECT id, name FROM disease_library where section_id = "+ sectionId +"";
	...
	public List<Map<String, Object>> findDiseaseById(Integer id) throws SQLException {
		String sql = "select id,name,bio,user_icon,user_name,user_put_question,doctor_icon,doctor_name,doctor_answer_question,symptom,cure,prompt,section_id,doctor_id  from   disease_library where id="
				+ id + "";
		DBUtil dbUtil = new DBUtil(sql);
		List<Map<String, Object>> list = new ArrayList<Map<String, Object>>();
		ResultSet result = null;
